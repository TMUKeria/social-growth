...
Supabase SQL Editor에서 `supabase/migrations/202608180001_initial_schema.sql`을 실행합니다. 이 파일은 `profiles`, `scenarios`, `steps`, `choices` 테이블과 RLS(Row Level Security, 행마다 접근 권한을 검사하는 보안 규칙)를 생성합니다.
