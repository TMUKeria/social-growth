    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        <div className="flex flex-wrap items-end justify-between gap-5">
          ...
          <button className="min-h-14 rounded-xl bg-[#3157d5] px-6 text-lg font-black text-white hover:bg-[#2543a9]" type="button">
            + 새 시나리오 만들기
          </button>
        </div>
        ...
        <div className="mt-10 rounded-3xl border-2 border-dashed border-slate-300 bg-white px-6 py-16 text-center">
          ...
          <p className="mt-3 text-slate-600">다음 개발 단계에서 시나리오 편집기를 연결합니다.</p>
        </div>
      </section>
    </main>
  );
